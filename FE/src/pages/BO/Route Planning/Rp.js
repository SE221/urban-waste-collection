      ...
      <React.Fragment>
                         <ul class="nav nav-pills mb-3 mt-1" id="pills-tab" role="tablist">
                           <li class="nav-item" role="presentation">
                            <button className= {showtab===1? "nav-link active": "nav-link" }  onClick={()=>handletab(1)}>Create Route</button>
                            <button className= {showtab===2? "nav-link active": "nav-link" }  onClick={()=>handletab(2)}>Route</button>
                            <button className= {showtab===3? "nav-link active": "nav-link" }  onClick={()=>handletab(3)}>Assign Vehicle</button>
                           </li>
                          </ul>
        ...
        <div class="tab-content text-dark" id="pills-tabContent">
            ...
            <DragDropContext onDragEnd={handleDragEnd}>
                       <table className="table borderd" style={{height:'50%'}}>
          <thead >
            <tr>
              <th  style={{color: "black"}}/>
              <th style={{color: "black"}}>Collector Id</th>
              <th style={{color: "black"}}>Collectors' name</th>
            </tr>
          </thead>
        ...
        <table className="table borderd" style={{width:'100%'}}>
          <thead>
            <tr>
              <th style={{color: "black"}} />
              <th style={{color: "black"}}>Vehicle license plates</th>
            </tr>
          </thead>
          <Droppable droppableId="droppable-1">
            {(provider) => (
